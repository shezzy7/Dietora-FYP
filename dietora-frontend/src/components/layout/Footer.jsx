      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-xs mt-4 text-slate-400 dark:text-slate-500 font-semibold tracking-wide uppercase">
              FYP Project — Government College University Faisalabad
            </p>
            {/* Team members */}
            <p className="text-xs mt-2 text-slate-400 dark:text-slate-500">
              Shahzad Hussain · Zainab Saleem · Hanzla Faiz
            </p>
          </div>
